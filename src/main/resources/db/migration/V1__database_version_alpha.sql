...
-- ddl-end --
ALTER TABLE public.base_model OWNER TO postgres;
-- ddl-end --
...
;
-- ddl-end --
ALTER TABLE public.base_model_with_ownership OWNER TO postgres;
-- ddl-end --
...
;
-- ddl-end --
ALTER TABLE public.project_visibility OWNER TO postgres;
-- ddl-end --
...
;
-- ddl-end --
ALTER TABLE public.application_visibility OWNER TO postgres;
-- ddl-end --
...
;
-- ddl-end --
ALTER TABLE public.application_event OWNER TO postgres;
-- ddl-end --
...
;
-- ddl-end --
ALTER TABLE public.http_api OWNER TO postgres;
-- ddl-end --
...
;
-- ddl-end --
ALTER TABLE public.http_request OWNER TO postgres;
-- ddl-end --
...
;
-- ddl-end --
ALTER TABLE public.http_api_event OWNER TO postgres;
-- ddl-end --
...
;
-- ddl-end --
ALTER TABLE public.http_api_enviroment OWNER TO postgres;
-- ddl-end --
...
;
-- ddl-end --
ALTER TABLE public.object_dictionary OWNER TO postgres;
-- ddl-end --
...
;
-- ddl-end --
ALTER TABLE public.object_dictionary_event OWNER TO postgres;
-- ddl-end --
...
;
-- ddl-end --
ALTER TABLE public.http_request_event OWNER TO postgres;
-- ddl-end --

-- object: public.object_dictionary_entry | type: TABLE --
-- DROP TABLE IF EXISTS public.object_dictionary_entry CASCADE;
CREATE TABLE public.object_dictionary_entry(
                                               object_dictionary_entry_id uuid NOT NULL,
                                               name character varying(255) NOT NULL,
                                               description text,
                                               object_dictionary_id uuid NOT NULL,
...
-- 	softdeleted bool NOT NULL DEFAULT false,
-- 	softdeleted_at timestamp with time zone,
                                               CONSTRAINT pk_object_dictionary_entry PRIMARY KEY (object_dictionary_entry_id)

) INHERITS(public.base_model_with_ownership)
;
-- ddl-end --
ALTER TABLE public.object_dictionary_entry OWNER TO postgres;
-- ddl-end --

-- object: public.object_dictionary_entry_event | type: TABLE --
-- DROP TABLE IF EXISTS public.object_dictionary_entry_event CASCADE;
CREATE TABLE public.object_dictionary_entry_event(
                                                     object_dictionary_entry_event_id uuid NOT NULL,
                                                     event text NOT NULL,
...
-- 	softdeleted bool NOT NULL DEFAULT false,
-- 	softdeleted_at timestamp with time zone,
                                                     CONSTRAINT pk_object_dictionary_entry_event PRIMARY KEY (object_dictionary_entry_event_id)

) INHERITS(public.base_model)
;
-- ddl-end --
ALTER TABLE public.object_dictionary_entry_event OWNER TO postgres;
-- ddl-end --
...
;
-- ddl-end --
ALTER TABLE public.object_dictionary_visibility OWNER TO postgres;
-- ddl-end --
...
;
-- ddl-end --
ALTER TABLE public.http_api_visibility OWNER TO postgres;
-- ddl-end --
...
ALTER TABLE public.base_model_with_ownership ADD CONSTRAINT fk_ownership_created_by FOREIGN KEY (created_by)
...
ALTER TABLE public.base_model_with_ownership ADD CONSTRAINT fk_ownershop_owned_by FOREIGN KEY (owned_by)
    REFERENCES public."user" (user_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.application ADD CONSTRAINT application_project_pk FOREIGN KEY (project_id)
...
ALTER TABLE public.project_visibility ADD CONSTRAINT fk_project_visibility_user FOREIGN KEY (user_id)
    REFERENCES public."user" (user_id) MATCH FULL
    ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.project_visibility ADD CONSTRAINT fk_project_visibility_project FOREIGN KEY (project_id)
    REFERENCES public.project (project_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.application_visibility ADD CONSTRAINT fk_application_visibility_application FOREIGN KEY (application_id)
...
ALTER TABLE public.application_visibility ADD CONSTRAINT fk_application_visibility_user FOREIGN KEY (user_id)
    REFERENCES public."user" (user_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.project_event ADD CONSTRAINT fk_project_event_project FOREIGN KEY (project_id)
    REFERENCES public.project (project_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.project_event ADD CONSTRAINT fk_project_event_user FOREIGN KEY (user_id)
    REFERENCES public."user" (user_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.application_event ADD CONSTRAINT fk_application_event_application FOREIGN KEY (application_id)
    REFERENCES public.application (application_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.application_event ADD CONSTRAINT fk_application_event_user FOREIGN KEY (user_id)
    REFERENCES public."user" (user_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.http_api ADD CONSTRAINT fk_http_api_application FOREIGN KEY (application_id)
    REFERENCES public.application (application_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.http_request ADD CONSTRAINT fk_http_request_http_api FOREIGN KEY (http_api_id)
...
ALTER TABLE public.http_request ADD CONSTRAINT fk_deprecated_for FOREIGN KEY (deprecated_for)
...
ALTER TABLE public.http_api_event ADD CONSTRAINT fk_http_api_event_http_api FOREIGN KEY (http_api_id)
    REFERENCES public.http_api (http_api_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.http_api_event ADD CONSTRAINT fk_http_api_user FOREIGN KEY (user_id)
    REFERENCES public."user" (user_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.http_api_enviroment ADD CONSTRAINT fk_http_api_enviroment_http_api FOREIGN KEY (http_api_id)
    REFERENCES public.http_api (http_api_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.http_api_enviroment ADD CONSTRAINT fk_http_api_enviroment_user FOREIGN KEY (user_id)
    REFERENCES public."user" (user_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.object_dictionary ADD CONSTRAINT fk_object_dictionary_application FOREIGN KEY (application_id)
    REFERENCES public.application (application_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.object_dictionary_event ADD CONSTRAINT fk_object_dictionary_event_object_dictionary FOREIGN KEY (object_dictionary_id)
...
ALTER TABLE public.object_dictionary_event ADD CONSTRAINT fk_object_dictionary_event_user FOREIGN KEY (user_id)
    REFERENCES public."user" (user_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.http_request_event ADD CONSTRAINT fk_http_request_event_http_request FOREIGN KEY (http_request_id)
    REFERENCES public.http_request (http_request_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.http_request_event ADD CONSTRAINT fk_http_request_event_user FOREIGN KEY (user_id)
    REFERENCES public."user" (user_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --

-- object: fk_object_dictionary_entry_object_dictionary | type: CONSTRAINT --
-- ALTER TABLE public.object_dictionary_entry DROP CONSTRAINT IF EXISTS fk_object_dictionary_entry_object_dictionary CASCADE;
ALTER TABLE public.object_dictionary_entry ADD CONSTRAINT fk_object_dictionary_entry_object_dictionary FOREIGN KEY (object_dictionary_id)
    REFERENCES public.object_dictionary (object_dictionary_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --

-- object: fk_object_dictionary_entry_event_object_dicionary_entry | type: CONSTRAINT --
-- ALTER TABLE public.object_dictionary_entry_event DROP CONSTRAINT IF EXISTS fk_object_dictionary_entry_event_object_dicionary_entry CASCADE;
ALTER TABLE public.object_dictionary_entry_event ADD CONSTRAINT fk_object_dictionary_entry_event_object_dicionary_entry FOREIGN KEY (object_dicionary_entry_id)
    REFERENCES public.object_dictionary_entry (object_dictionary_entry_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --

-- object: fk_object_dictionary_entry_event_user | type: CONSTRAINT --
-- ALTER TABLE public.object_dictionary_entry_event DROP CONSTRAINT IF EXISTS fk_object_dictionary_entry_event_user CASCADE;
ALTER TABLE public.object_dictionary_entry_event ADD CONSTRAINT fk_object_dictionary_entry_event_user FOREIGN KEY (user_id)
    REFERENCES public."user" (user_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.notification ADD CONSTRAINT fk_notification_to FOREIGN KEY ("to")
    REFERENCES public."user" (user_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.notification ADD CONSTRAINT fk_notification_from FOREIGN KEY ("from")
    REFERENCES public."user" (user_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.object_dictionary_visibility ADD CONSTRAINT fk_object_dictionary_visibility_user FOREIGN KEY (user_id)
    REFERENCES public."user" (user_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.object_dictionary_visibility ADD CONSTRAINT fk_object_dictionary_visibility_object_dictionary FOREIGN KEY (object_dictionary_id)
    REFERENCES public.object_dictionary (object_dictionary_id) MATCH FULL
    ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.http_api_visibility ADD CONSTRAINT fk_http_api_visibility_http_api FOREIGN KEY (http_api_id)
    REFERENCES public.http_api (http_api_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.http_api_visibility ADD CONSTRAINT fk_http_api_visibility_user FOREIGN KEY (user_id)
    REFERENCES public."user" (user_id) MATCH FULL
    ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
